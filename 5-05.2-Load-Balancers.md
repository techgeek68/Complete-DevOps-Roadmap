...
- It's primary goal is to prevent any single server from becoming a bottleneck.
- Uses:
...
| **Least Response Time** | Routes to the server with the fastest response time *and* fewest connections. | Performance-critical applications requiring low latency. |
...
**Prerequisites and Architecture**
  - To complete this lab following requirements are needed.
