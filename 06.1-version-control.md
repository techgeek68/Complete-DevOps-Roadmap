...
Example: A shared to-do list: "Task #12: Scan Mom's wedding photos (priority:
high)".

README.md:
→ Fact: The first file displayed in a repo (supports Markdown formatting).
Example: Album cover + table of contents: "Summer 2025 - Beach Trip (Pages 1-
20)".
...
- Creates independent lines of development without affecting main code
- Commands:
